...
class Release(models.Model):
    ...
    def create_journals(self):
        ledgerjournal = LedgerJournal.objects.create(
            ...
            journal_type  = JournalType.LJ
        )
        accountjournal = AccountJournal.objects.create(
            content_object=self, desc="Loan Released",
            journal_type  = JournalType.AJ
        )
    ...
    def get_journals(self):
        ...
        ledgerjournal = self.journals.filter(release_doc = self,journal_type=JournalType.LJ)
        accountjournal = self.journals.filter(release_doc = self,journal_type=JournalType.AJ)
