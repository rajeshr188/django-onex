...
# approval urls
    ...
    path('approval/<int:pk>/detail/',views.ApprovalDetailView.as_view(),
                name = 'approval_approval_detail'),
    path('approval/create/',views.ApprovalCreateView.as_view(),
                name ='approval_approval_create'),
    path('approval/<int:pk>/update/',views.ApprovalUpdateView.as_view(),
                name = 'approval_approval_update'),
    path('approval/<int:pk>/delete/',views.ApprovalDeleteView.as_view(),
