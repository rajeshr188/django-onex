...
urlpatterns += (
    ...
    path('customer/create/', views.create_customer, name='contact_customer_create'),
    path('customer/detail/<int:pk>/', views.CustomerDetailView.as_view(), name='contact_customer_detail'),
    path('customer/update/<int:pk>/', views.edit_customer, name='contact_customer_update'),
    path('customer/<int:pk>/delete/',views.delete_customer,name='contact_customer_delete'),
    ...
    path('customer/remove/<int:pk>/', views.delete_customer,
         name='contact_delete_customer'),
    path('customer/filter/', views.CustomerListFilterView.as_view(), name='contact_customer_filter'),
)
